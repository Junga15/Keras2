...
y1_train,y1_test,y2_train,y2_test=train_test_split(y1,y2,shuffle=False,train_size=0.7)

# x와 y의 train_size가 다르면 
...
dense1=Dense(10,activation='relu')(input1) #model.summary() dense부분의 가독성을 위해
dense1=Dense(5, activation='relu')(dense1)
dense1=Dense(3)(dense1)

#모델 분기1: output모델 구성, 분기는 나눈다.
...
#모델 선언
model=Model(inputs=input1, #2개이상은 리스트로 묶는다.[]

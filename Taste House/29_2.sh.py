...
x1=np.array([[1,2,3],[2,3,4],[3,4,5],[4,5,6],[5,6,7],[6,7,8],[7,8,9],[8,9,10],[9,10,11],[10,11,12],[20,30,40],[30,40,50],[40,50,60]]).reshape(13,3)
...
dense1 = Dense(32,activation='relu')(inputs1)
dense1 = Dense(16,activation='relu')(dense1)
dense1 = Dense(8,activation='relu')(dense1)

inputs2 = Input(shape=(3,1))
lstm2 = LSTM(32,activation='relu')(inputs2)
dense2 = Dense(32,activation='relu')(lstm2)

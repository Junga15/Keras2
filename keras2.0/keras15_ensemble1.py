<<<<<<< HEAD:keras2.0/keras15_ensemble1.py
#keras15_ensemble1.py 실습
#Input이 2개,Output이 2개, 즉 데이터 구성시 x값이 2개,y값이 2개
# 다대다(2:2)앙상블 모델구현 (※10_3모델 다대다 다층퍼셉트론 모델 가져옴)
#두개 모두 덴스형 함수형 모델로 구현했음
#실습.위 두개의 모델을 합한 RMSE와 R2값도 구하라.(위의 print(loss)=두개통합 로스값처럼)

'''
====================
[3504.869873046875, 2336.531982421875, 1168.338134765625, 41.61107635498047, 27.34322738647461]
model.metrics_names: ['loss', 'dense_12_loss', 'dense_16_loss', 'dense_12_mae', 'dense_16_mae']
====================
y1_predict:
 [[800.5207    21.019638 242.76799 ]
 [801.6176    21.0073   243.07729 ]
..... 
 [820.26624   20.79716  248.33562 ]
 [821.3632    20.784803 248.64497 ]]
====================
y2_predict:
 [[566.48883  799.6332    33.210896]
 [567.2308   800.7153    33.27792 ]
 ......
 [579.1021   818.03033   34.348827]
 [579.84393  819.1125    34.415787]
 [580.58594  820.19464   34.48279 ]]
RMSE1: 48.337691009237446
RMSE2: 34.180955395563515
RMSE: 41.25932320240048
r2_1: -69.27165028885757
r2_2: -34.13797629333842
r2: -51.70481329109799
'''
...
#덴스형 함수모델1
input1=Input(shape=(3,)) #인풋쉐이프는 transpose후 (100,3)으로 수정했으므로
dense1=Dense(10,activation='relu')(input1)
dense1=Dense(5, activation='relu')(dense1)
#output1=Dense(3)(dense1) #아웃풋값의 노드의 갯수 3
...
dense2=Dense(5, activation='relu')(dense2)
dense2=Dense(5, activation='relu')(dense2)
#output2=Dense(3)(dense2) #아웃풋값의 노드의 갯수 3
...
output1=Dense(3)(output1)  #아웃풋값의 노드의 갯수 3

#모델 분기2
output2=Dense(30)(middle1)
output2=Dense(7)(output2)
output2=Dense(7)(output2)
output2=Dense(3)(output2)  #아웃풋값의 노드의 갯수 3
...
model.fit([x1_train,x2_train],[y1_train,y2_train],
          ...
          validation_split=0.2, verbose=1)  #트레인,테스트 분리했으므로 
...
y2_predict:
 ...
 [654.09174  906.2185    43.655693]]
'''
>>>>>>> e4d20bf972fb001f76ae90d52362c18532f65c9e:keras15_ensemble1.py

<<<<<<< HEAD:keras2.0/keras18_boston4_MinmaxScalar2.py
#.keras18_boston4_MinMaxScalar2.py 실습★
...
#:기준을 x_train만 잡고 전처리 진행 
#x_train은 fit,transform, x_val,x_test,
# x_predict는 transform만 진행
...
y_predict=model.predict(x_test) # x_predict는 transform만 진행
#print(y_predict)
...
>>>>>>> e4d20bf972fb001f76ae90d52362c18532f65c9e:keras18_boston4_MinmaxScalar2.py

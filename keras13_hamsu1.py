...
input1=Input(shape=(1,)) #Input layer를 직접구성하겠다. 
...
model.fit(x_train,y_train,epochs=5000,batch_size=1,validation_split=0.2,verbose=0) #각 칼럼별로 20%, x중 1,2 and 11,12
